...
const ProductCards = ({data, handleShow}) => {
  return (
    <div className=" h-80 border-2 w-64 rounded-3xl p-4 flex flex-col gap-4 bg-slate-100 cursor-pointer" onClick={()=>handleShow(data.id)}>
        ...
        <div className="h-[35%]">
            ...
            <p className="w-[100%]">{(data.description).length < 30 
            ? data.description
